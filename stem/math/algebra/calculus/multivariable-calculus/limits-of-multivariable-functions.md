...
- ### eg (polar coordinates)：$`\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\left(x^2+y^2\right)\cdot \ln{\left(x^2+y^2\right)}}`$
...
- ### eg：$`\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^2y^2}{x^2+y^2}}`$
    - $`x^2+y^2\ge y^2 \implies 0\le |\frac{x^2y^2}{x^2+y^2}| \le \frac{x^2y^2}{y^2} \implies 0\le \frac{x^2y^2}{x^2+y^2} \le x^2`$
    - $`\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{0}=\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{x^2}=0 \implies \lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^2y^2}{x^2+y^2}}=0`$
...
- ### ε-δ definition ($`\forallε>0,~\existsδ>0`$)
    - #### $`0<\sqrt{\left(x_1-a_1\right)^2+\cdots +\left(x_n-a_n\right)^2}<δ\implies|f\left(x_1,~\cdots,~x_n\right)-L|<ε`$
- ### eg：$`\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^4}{x^2+y^2}}=0`$
    1. $`\text{Let }\begin{cases} {x=r\cos{θ}}\\{y=r\sin{θ}} \end{cases}`$
    2. $`\forallε>0,~\existsδ>0,~\text{Such that }0<\sqrt{x^2+y^2}<δ\implies|\frac{x^4}{x^2+y^2}|<ε`$
    3. $`x^2\le x^2+y^2 \implies \frac{x^2}{x^2+y^2}\le 1 \implies |\frac{x^4}{x^2+y^2}|\le x^2<ε \implies x<\sqrt{ε}`$
    4. $`x^2\le x^2+y^2 \implies x\le \sqrt{x^2+y^2}<δ \implies x<δ`$
    5. $`δ=\sqrt{ε} \implies \lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^4}{x^2+y^2}}=0`$
- ### eg：$`\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^4}{x^2+y^2}}=0`$
    1. $`\text{Let }\begin{cases} {x=r\cos{θ}}\\{y=r\sin{θ}} \end{cases}`$
    2. $`\lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^4}{x^2+y^2}}=\lim\limits_{r\to 0}{\left(r^2\cos^4{θ}\right)}=0`$
    3. $`\forallε>0,~\existsδ>0,~\text{Such that }0<r<δ\implies|r^2\cos^4{θ}|<ε`$
    4. $`\cos{θ}\le 1 \implies |r^2\cos^4{θ}|\le r^2<ε \implies r<\sqrt{ε}`$
    5. $`δ=\sqrt{ε} \implies \lim\limits_{\left(x,~y\right)\to \left(0,~0\right)}{\frac{x^4}{x^2+y^2}}=0`$
