...
- ### [Pythagorean Identities](/stem/math/trigonometric-functions-and-hyperbolic-functions/trigonometric-functions.md#pythagorean-identities)：$`\sin^2{x}+\cos^2{x}=1`$
...
- ### [Power Reduction Formulas](/stem/math/trigonometric-functions-and-hyperbolic-functions/trigonometric-functions.md#power-reduction-formulas)：$`\sin^2{x}=\frac{1-\cos{2x}}{2},~\cos^2{x}=\frac{1+\cos{2x}}{2}`$
...
## eg
- ### eg：$`\int{\cos^5{x}\,dx}`$
    - ### [Pythagorean Identities](/stem/math/trigonometric-functions-and-hyperbolic-functions/trigonometric-functions.md#pythagorean-identities)：$`\int{\cos^5{x}\,dx} = \int{\cos^4{x}\cos{x}\,dx} = \int{\left(1-\sin^2{x}\right)^2\cos{x}\,dx}`$
...
- ### eg：$`\int{\cos^4{x}\,dx}`$
    - ### [Power Reduction Formulas](/stem/math/trigonometric-functions-and-hyperbolic-functions/trigonometric-functions.md#power-reduction-formulas)：$`\int{\cos^4{x}\,dx} = \int{\left(\frac{1+\cos{2x}}{2}\right)^2\,dx}`$
