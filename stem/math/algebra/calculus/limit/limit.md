...
- ### eg：$`\lim\limits_{x\to 0}{\left(\frac{x}{|x|}+x\right)}`$
    ...
    - #### Right-sided Limit：$`\lim\limits_{x\to 0^+}{\left(\frac{x}{|x|}+x\right)}=\frac{x}{|x|}+x=\frac{x}{x}+x=1.\cdots`$
        - $`x=0.0\cdots 1`$
    - #### $`\lim\limits_{x\to 0^-}{\left(\frac{x}{|x|}+x\right)}\neq\lim\limits_{x\to 0^+}{\left(\frac{x}{|x|}+x\right)} \Rightarrow \lim\limits_{x\to 0}{\left(\frac{x}{|x|}+x\right)}\text{ does not exist}`$
...
- ### ε-δ definition \left($`\forallε>0,~\existsδ>0`$\right)
    - #### $`0<|x-a|<δ\Rightarrow|f\left(x\right)-L|<ε`$
- ### eg：$`\lim\limits_{x\to 3}{\left(4x+1\right)}=13`$
    1. $`\forallε>0,~\existsδ>0,~\text{Such that }0<|x-3|<δ\Rightarrow|\left(4x+1\right)-13|<ε`$
    2. $`|4x-12|<ε`$
    3. $`|x-3|<\frac{ε}{4}`$
    4. $`δ=\frac{ε}{4}\Rightarrow \lim\limits_{x\to 3}{\left(4x+1\right)}=13`$
