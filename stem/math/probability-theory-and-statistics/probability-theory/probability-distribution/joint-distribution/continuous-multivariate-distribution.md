...
|[PDF](../distribution-function.md#probability-function)|$`\frac{1}{\sqrt{\left(2π\right)^n det\left(Σ\right)}}\cdot \exp{\left(-\frac{1}{2}\left(x-μ\right)^TΣ^{-1}\left(x-μ\right)\right)}`$|
