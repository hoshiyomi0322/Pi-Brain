...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`p^x(1-p)^{1-x}=\begin{cases}{1-p}&{\text{for }x=0}\\ p&{\text{for }x=1}\end{cases}`$|
...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`C_x^np^x(1-p)^{n-x}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
...
|[PMF](../distribution-function.md#probability-mass-function-pmf)||
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
...
|Parameters|$`p=\text{probability of success}`$|
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`p(1-p)^{x-1}`$|
...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`H^r_x\cdot p^r(1-p)^x`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
