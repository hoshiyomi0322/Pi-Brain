...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`\frac{1}{n}`$|
...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`\frac{n!}{x_1!\cdots x_k!}\cdot(p_1^{x_1}\times\cdots\times p_k^{x_k})`$|
...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`\frac{\binom{K}{x}\binom{N-K}{n-x}}{\binom{N}{n}}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
...
|[PMF](../distribution-function.md#probability-mass-function-pmf)|$`\frac{λ^xe^{-λ}}{x!}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
