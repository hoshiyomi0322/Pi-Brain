...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean ($`μ`$)](../expected-value.md)|$`\frac{α}{β}`$|
...
|[Mean ($`μ`$)](../expected-value.md)|$`\frac{1}{λ}`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean ($`μ`$)](../expected-value.md)|$`\frac{k}{λ}`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean ($`μ`$)](../expected-value.md)|$`λ\cdot Γ(1+\frac{1}{K})`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean ($`μ`$)](../expected-value.md)|$`\frac{α}{α+β}`$|
