...
|[PDF](../distribution-function.md#probability-density-function-pdf)|$`\frac{1}{Γ(α)θ^α}\cdot x^{α-1} \cdot e^{-x/θ}`$|
...
|[PDF](../distribution-function.md#probability-density-function-pdf)|$`\frac{β^α}{Γ(α)}\cdot x^{α-1} \cdot e^{-xβ}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
...
|[PDF](../distribution-function.md#probability-density-function-pdf)|$`λe^{-λx}`$|
...
|[PDF](../distribution-function.md#probability-density-function-pdf)|$`\frac{λ^kx^{k-1}e^{-λx}}{Γ(k)}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
...
|[PDF](../distribution-function.md#probability-density-function-pdf)|$`\frac{k}{λ}\cdot(\frac{x}{λ})^{k-1}\cdot \exp{(-(\frac{x}{λ})^k)}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
...
|[PDF](../distribution-function.md#probability-density-function-pdf)|$`\frac{x^{α-1}(1-x)^{β-1}}{B(α,β)}`$|
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
