...
|[Random Variable](../../probability-theory.md#random-variable)|$X$ = number of successes|
...
|[Mean](../../expected-value.md)|$`p`$|
|[Variance](../../../statistics/variance.md#variance)|$`p\left(1-p\right)`$||
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`np`$|
|[Variance](../../../statistics/variance.md#variance)|$`np\left(1-p\right)`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`\sum\limits_{i=1}^{n}{p_i}`$|
|[Variance](../../../statistics/variance.md#variance)|$`\sum\limits_{i=1}^{n}{p_i\left(1-p_i\right)}`$|
...
|[Random Variable](../../probability-theory.md#random-variable)|$X$ = number of trials|
|Parameters|$`p=\text{probability of success}`$|
...
|[Mean](../../expected-value.md)|$`\frac{1}{p}`$|
|[Variance](../../../statistics/variance.md#variance)|$`\frac{1-p}{p^2}`$|
...
|[Random Variable](../../probability-theory.md#random-variable)|$X$ = number of failures|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`r\left(\frac{1-p}{p}\right)`$|
|[Variance](../../../statistics/variance.md#variance)|$`r\left(\frac{1-p}{p^2}\right)`$|
