...
|[Mean](../../expected-value.md)|$`αθ`$|
|[Variance](../../../statistics/variance.md#variance)|$`αθ^2`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`\frac{α}{β}`$|
|[Variance](../../../statistics/variance.md#variance)|$`\frac{α}{β^2}`$|
...
|[Mean](../../expected-value.md)|$`\frac{1}{λ}`$|
|[Variance](../../../statistics/variance.md#variance)|$`\frac{1}{λ^2}`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`\frac{k}{λ}`$|
|[Variance](../../../statistics/variance.md#variance)|$`\frac{k}{λ^2}`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`λ\cdot Γ\left(1+\frac{1}{K}\right)`$|
|[Variance](../../../statistics/variance.md#variance)|$`λ^2\cdot Γ\left(1+\frac{2}{k}\right)-μ^2`$|
...
|Situation|
|[Random Variable](../../probability-theory.md#random-variable)|$`X\in\left[0,~1\right]`$|
...
|[CDF](../distribution-function.md#cumulative-distribution-function-cdf)||
|[Mean](../../expected-value.md)|$`\frac{α}{α+β}`$|
|[Variance](../../../statistics/variance.md#variance)|$`\frac{αβ}{\left(α+β\right)^2\left(α+β+1\right)}`$|
