...
- ### Correlation Coefficient：$`r=\frac{σ_{xy}}{σ_xσ_y}=\frac{D_{xy}}{nσ_xσ_y}=\frac{\sum\limits_{i=1}^{n}(x_i-μ_x)(y_i-μ_y)}{\sqrt{\sum\limits_{i=1}^{n}(x_i-μ_x)^2}\sqrt{\sum\limits_{i=1}^{n}(y_i-μ_y)^2}}=\frac{\sum\limits_{i=1}^{n}{x_iy_i}-nμ_xμ_y}{\sqrt{\sum\limits_{i=1}^{n}{x_i}^2-n{μ_x}^2}\sqrt{\sum\limits_{i=1}^{n}{y_i}^2-n{μ_y}^2}}`$
