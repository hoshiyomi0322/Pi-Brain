...
- ### 弾：236P
    - #### 溜め弾：236P(Hold到改變狀態)
        - 溜め弾1：236P(Hold到顏色變化)
        - 溜め弾2：236P(顏色變化後不放開繼續Hold一段)
        - OD溜め弾：236PP(Hold)
    - #### delay弾：236P(Hold，但不改變狀態)
        - delay弾：236P(Hold但在顏色變化前放開、與原本的弾一樣)
        - OD delay弾：236PP(Hold但在顏色變化前放開、與原本的弾一樣)
    - #### 空弾：9 + 236P
- ### 灼火：214P
    - #### 灼火派生：214P + 6P
- ### 昇竜：623P
...
- ### 48F OKI
    - 消費(9) + [5F打摔擇]()
    - その場受け身/Corner
        - 消費(弱旋風腳/弱灼火) + [5HP OKI](#5hp-oki-6f8f)
        - 消費(中灼火) + [5F打摔擇]()
- ### 50F OKI
    - 消費(9 + JHK) + [5F打摔擇]()
    - 消費(前ステ) + [30F OKI](#30f-oki-30f31f)
    - その場受け身/Corner
        - 消費(強灼火) + [5F打摔擇]()
