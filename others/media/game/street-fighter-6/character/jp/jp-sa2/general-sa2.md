...
- SA2 + (5LP + DI) + 強裂縫 + 2LK + 安全飛び(JLK) + (8 + [F式](../jp.md#f式))/2MK + [Air 6HK Combo]()
...
- SA2 + (2MK + OD裂縫(中強)) + (前ステ + 5LP + 2MK) + バクステ + [強風神 Combo]()/[2HP Reset]()
    - SA2 + (2MK + OD裂縫(中強)) + (前ステ + 5LP + 2MK) + バクステ + [強TC Combo](../jp.md#強tc-combo)
- SA2 + 2HP + (9 + [F式](../jp.md#f式)) + 強裂縫 + [SA2強裂縫Extension Combo]()/[通用Midscreen 裂縫投げ擇]()
...
- SA2 + (5MK + 弱風神 + OD裂縫(弱強)) + (2LP + 2HP) + [中下弾擇]()/[左右擇]()/[前跳擇]()
    ...
    - #### 左右擇
        - 裂縫傳送(弱)
            ...
            - 裂縫傳送(弱) + ガード(JLK) + 2LK + [強風神 Combo]()
            - 裂縫傳送(弱) + [投げ](../jp.md#投げ)
        - 裂縫傳送(中)
            - 裂縫打中：裂縫傳送(中) + [強風神 Combo]()
            - 裂縫ガード：裂縫傳送(中) + Reset([JLK Combo]()/DI/コマ投げ)
    - #### 前跳擇
        - 裂縫打中：9 + [強風神 Combo]()
        - 裂縫ガード：9 + DI/コマ投げ/[JHK Combo]()
- SA2 + (5MK + 弱風神 + OD裂縫(弱中)) + (2LP + 2HP) + [左右擇]()/[前跳擇]()/[DRSwitch 擇]()
    - DR Switch 擇：CDR + delay(等DRSwitch ) + [裂縫打中]()/[裂縫ガード]()
        - 裂縫打中：[強風神 Combo]()
        - 裂縫ガード：[Switch 傳送擇]()/[中下擇]()
            - Switch 傳送擇：裂縫傳送 + [JLK Combo]()/[投げ](../jp.md#投げ)/DI/コマ投げ
            - 中下擇：6MK/2MK + [Air 6HK Combo]()

# F式 SA2 Reset
- ### Midscreen F式 SA2 Reset
