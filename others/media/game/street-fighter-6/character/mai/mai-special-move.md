...
- ### 中龍炎舞 Combo
    ...
    - 中龍炎舞 + (弱忍蜂 + [3F打摔擇(後ろ歩き)]())
- ### 強龍炎舞 Combo
    - 強龍炎舞 + [強昇竜 Combo]()/[弱忍蜂 Air Combo]()/SA2
    - (強龍炎舞 + 弱忍蜂) + 溜め弾
    - 強龍炎舞 + (中忍蜂 + [5F打摔擇(後ろ歩き)]())
    - Corner
        - 強龍炎舞 + SA1
...
- ### OD忍蜂 Air Combo
    ...
    - (OD忍蜂 + JMP) + [強昇竜 Combo]()
    - (OD忍蜂 + JMP) + (delay + 弱龍炎舞) + SA3
    - Corner：(OD忍蜂 + JMP) + (delay + 弱龍炎舞) + [強昇竜 Combo]()/SA1/SA2/SA3
    - #### 帶火 OD忍蜂 Air Combo
...
- ### OD空插 Combo
    - OD空插 + [強昇竜 Combo]()/SA2
    - Corner：OD空插 + [強昇竜 Combo]()/SA1/SA2
    - 帶火：OD空插 + [強昇竜 Combo]()/SA1/SA2/(弱忍蜂 + SA3)

# OD溜め弾 Combo
- Mid：OD溜め弾 + [5HP Combo]()
- Far：OD溜め弾 + [DR 5HP Combo]()
- OD溜め弾(帶火) + (9 + [JHK Combo]())
- [OD弾擇](#od弾擇)

# OD弾擇
- ガード(OD弾/OD溜め弾) + 前歩き + 2HK(ラッシュ止め)
- ガード(OD弾/OD溜め弾) + 等第二下 + 5F打摔擇
- ガード(OD弾/OD溜め弾) + DR + 中下擇(6MP/2MK)
- ガード(OD弾/OD溜め弾) + DR + 中下擇(ガード) + 5F打摔擇
