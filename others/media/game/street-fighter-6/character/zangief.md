...
- ### コマ投げ Combo
    ...
    - コマ投げ + (DR + 防パナシ/対空)
- ### 俄式背摔 Combo
    - 俄式背摔 + (DR + delay/5MK + [5F打摔擇](#5f打摔擇-3f5f)/防パナシ/対空)

# SA2 Combo
- (SA2 + 手) + 前ステ/(DR + 6MK) + 6MK + [8F打摔擇](#8f打摔擇)
- (SA2 + 手) + 前ステ + [3MP High-Air Combo](#3mp-high-air-combo)
- ### 前旋風手 Reset
    - その場受け身/Corner：(SA2 + 手) + 前ステ + (3MP + 前旋風手) + 消費(6MK) + [俄式背摔 Combo](#俄式背摔-combo)/[5F打摔擇](#5f打摔擇-3f5f)
    - 後方受け身：(SA2 + 手) + 前ステ + (3MP + 前旋風手) + 消費(6MK) + 西伯利亞
    - #### Midscreen 前旋風手 Reset
        - その場受け身/Corner：(SA2 + 手) + (DR + 6MK) + (3MP + 前旋風手) + 消費(6MK) + [俄式背摔 Combo](#俄式背摔-combo)/[8F打摔擇](#8f打摔擇)
...
- ### 3MP Air Combo
    - 3MP + 旋風手/SA1/[SA2 Air Combo](#sa2-air-combo)
    - 3MP + (9 + [5F打摔擇](#5f打摔擇-3f5f))
    - #### Corner 3MP Air Combo
        - [3MP Air Combo](#3mp-air-combo)
        - (3MP + OD旋風手) + (delay + 9 + Air-コマ投げ)
        - (3MP + OD旋風手) + (9 + [8F打摔擇](#8f打摔擇))
...
- #### DR 6MK Air Combo
    - (DR + 6MK) + (5LK + DI)
    - (DR + 6MK) + (2LP + delay + 西伯利亞)
    - Corner：(DR + 6MK) + (2LP + delay + [10F打摔擇](#10f打摔擇))
...
- ### 2HP PC Combo
    - 2HP(PC) + (DR + 6MK) + [3MP Air Combo](#3mp-air-combo)
    - 2HP(PC) + (DR + 6MK*2) + [10F打摔擇](#10f打摔擇)
    - Corner
...
- ### DI PC Combo
    ...
    - DI(PC) + 前ステ/(DR + 6MK) + [3MP Air Combo](#3mp-air-combo)
    - DI(PC) + (前ステ + 6MK) + 消費(6MK) + [8F打摔擇](#8f打摔擇)
...
- ### 前投げ
    ...
    - #### Corner 前投げ
- ### 後ろ投げ
    - その場受け身/Corner：後ろ投げ + [8F打摔擇](#8f打摔擇)
